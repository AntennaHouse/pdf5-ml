...
>
    ...
    <xsl:template match="*[contains(@class, ' ditaot-d/ditaval-startprop ')][exists(ancestor::*[. is $map])]" priority="20"/>
    <xsl:template match="*[contains(@class, ' ditaot-d/ditaval-endprop ')][exists(ancestor::*[. is $map])]" priority="20"/>
